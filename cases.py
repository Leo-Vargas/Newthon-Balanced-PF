...
def Class5Bus():
    Ybus = np.array([
        ...
        (-1/(0.03+0.08j), -1/(0.04+0.09j), 0, -1/(0.04+0.09j), (1/(0.03+0.08j)) + (1/(0.04+0.09j)) + (1/(0.04+0.09j)) + 0.03j)
    ])
...
def Class5BusOpened():
    Ybus = np.array([
        ((1/(0.05+0.11j)) + (1/(0.05+0.11j)) + (1/(0.03+0.08j)) + 0.03j, -1/(0.05+0.11j), 0, -1/(0.05+0.11j), 0, -1/(0.03+0.08j), 0, 0),
        (-1/(0.05+0.11j), (1/(0.05+0.11j)) + (1/(0.04+0.09j)) + (1/(0.04+0.09j)) + 0.03j, -1/(0.04+0.09j), 0, 0, 0, 0, -1/(0.04+0.09j)),
        (0, -1/(0.04+0.09j), 1/(0.04+0.09j) + 0.01j, 0, 0, 0, 0, 0),
        (-1/(0.05+0.11j), 0, 0, (1/(0.05+0.11j)) + (1/(0.06+0.13j)) + 0.025j, -1/(0.06+0.13j), 0, 0, 0),
        (0, 0, 0, -1/(0.06+0.13j), (1/(0.06+0.13j)) + (1/(0.04+0.09j)) + 0.025j, 0, -1/(0.04+0.09j), 0),
    ...
    loadsMw = np.array([0.0, 40.0, 12.5, 12.5, 40.0, 50.0/3, 50.0/3, 50.0/3])
