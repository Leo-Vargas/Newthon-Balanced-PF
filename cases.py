...
def GhendyCase():
    Ybus = np.array([
        (0.0236+0.0233j, -0.0236-0.0233j, 0, 0),
        (-0.0236-0.0233j, 0.0239+0.0235j, -0.0003-0.0002j, 0),
        (0, -0.0003-0.0002j, 0.0054+0.0007j, -0.0051-0.0005j),
        (0, 0, -0.0051-0.0005j, 0.0051+0.0005j)
    ])
